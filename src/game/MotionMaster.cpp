...
void MotionMaster::MoveRandom()
{
    ...
    else
    {
        ...
        Mutate(new RandomMovementGenerator<Creature>(*m_owner), UNIT_ACTION_CONFUSED);
    }
}
...
void MotionMaster::MovePoint(uint32 id, float x, float y, float z, bool generatePath)
{
    ...
    if (m_owner->GetTypeId() == TYPEID_PLAYER)
        Mutate(new PointMovementGenerator<Player>(id,x,y,z, generatePath), UNIT_ACTION_EFFECT);
    else
        Mutate(new PointMovementGenerator<Creature>(id,x,y,z, generatePath), UNIT_ACTION_EFFECT);
}
...
void MotionMaster::MoveSeekAssistance(float x, float y, float z)
{
    ...
    else
    {
        ...
        Mutate(new AssistanceMovementGenerator(x,y,z), UNIT_ACTION_EFFECT);
    }
}
...
void MotionMaster::MoveSeekAssistanceDistract(uint32 time)
{
    ...
    else
    {
        ...
        Mutate(new AssistanceDistractMovementGenerator(time), UNIT_ACTION_EFFECT);
    }
}
...
MotionMaster::MotionMaster(Unit *unit) : m_owner(unit), m_cleanFlag(MMCF_NONE)
{
}
