...
const char ChatChannelsEntryfmt[]="iixssssssssxsxxxxxxxx";
...
const char ItemRandomPropertiesfmt[]="nxiiiiissssssssx";
...
const char WorldStateEntryfmt[]="niixssssssssxxxxxxxxxxxixxxxxxxxxxxsiix";
