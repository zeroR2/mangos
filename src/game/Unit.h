...
enum UnitMods
{
    ...
    UNIT_MOD_HEALTH,
    UNIT_MOD_MANA,                                          // UNIT_MOD_MANA.. must be in existing order, it's accessed by index values of Powers enum.
    UNIT_MOD_RAGE,
    UNIT_MOD_FOCUS,
    UNIT_MOD_ENERGY,
    UNIT_MOD_HAPPINESS,
...
class MANGOS_DLL_SPEC Unit : public WorldObject
{
    public:
        ...
        {
            return GetAura(type, family, ClassFamilyMask(familyFlag), casterGuid);
        }
