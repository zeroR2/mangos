...
enum EUnitFields
{
    ...
    UNIT_FIELD_POSSTAT0                        = 0x3DD + UNIT_END, // Size:1
    UNIT_FIELD_POSSTAT1                        = 0x3DE + UNIT_END, // Size:1
    UNIT_FIELD_POSSTAT2                        = 0x3DF + UNIT_END, // Size:1
    UNIT_FIELD_POSSTAT3                        = 0x3E0 + UNIT_END, // Size:1
    UNIT_FIELD_POSSTAT4                        = 0x3E1 + UNIT_END, // Size:1
    UNIT_FIELD_NEGSTAT0                        = 0x3E2 + UNIT_END, // Size:1
    UNIT_FIELD_NEGSTAT1                        = 0x3E3 + UNIT_END, // Size:1
    UNIT_FIELD_NEGSTAT2                        = 0x3E4 + UNIT_END, // Size:1
    UNIT_FIELD_NEGSTAT3                        = 0x3E5 + UNIT_END, // Size:1,
    UNIT_FIELD_NEGSTAT4                        = 0x3E6 + UNIT_END, // Size:1
    UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE      = 0x3E7 + UNIT_END, // Size:7
    UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE      = 0x3EE + UNIT_END, // Size:7
