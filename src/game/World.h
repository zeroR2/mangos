...
enum eConfigUInt32Values
{
    ...
    CONFIG_UNIT32_OPVP_WG_START_DEFENDER_TEAM,
    CONFIG_UNIT32_OPVP_WG_DISABLE_CHANGE_TEAM_TIMER,
    CONFIG_UNIT32_OPVP_WG_CONTROL_PHASE_TIMER,
    CONFIG_UNIT32_OPVP_WG_BATTLE_PHASE_TIMER,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_OUTDOORPVP_WG_DISABLE_CHANGE_TEAM,
