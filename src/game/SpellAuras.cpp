    ...
    switch(m_modifier.m_auraname)
    {
        ...
        case SPELL_AURA_PERIODIC_DAMAGE_PERCENT:
        {
            ...
            switch (GetId())
            {
                ...
                {
                    target->CastSpell(target, 74795, true, NULL, NULL, GetAffectiveCasterGuid());
                    break;
                }
                case 67297:
                case 65950:
...
//              case 50530: break;
                ...
                case 63477:
                {
                    ...
                    if (caster && target)
                        caster->CastSpell(target, (spell->Id == 62717) ? 65722 : 65723, true, 0, this, this->GetAffectiveCasterGuid(), this->GetSpellProto());
                    return;
                }
...
//                return;
        ...
        case SPELLFAMILY_HUNTER:
        {
            ...
            {
                target->CastCustomSpell(target, 53352, &m_modifier.m_amount, 0, 0, true, 0, this, GetAffectiveCasterGuid());
                return;
            }
            switch (spell->Id)
            {
...
void Aura::HandleAuraLinked(bool apply, bool Real)
{
    ...
    if (apply)
    {
            ...
            spellInfo->Attributes &  SPELL_ATTR_HIDE_IN_COMBAT_LOG)
        {
            ...
            pTarget->CastCustomSpell(pTarget, spellInfo, &bp0, &bp1, &bp2, true, NULL, this, GetAffectiveCasterGuid(), GetSpellProto());
            ...
            (GetSpellProto()->SpellIconID == 264 || GetSpellProto()->SpellIconID == 1933))
        {
            ...
            if (pCaster)
                pCaster->CastCustomSpell(pTarget, spellInfo, &bp0, NULL, NULL, true, NULL, this, GetAffectiveCasterGuid(), GetSpellProto());
        }
        else
            pTarget->CastSpell(pTarget, spellInfo, true, NULL, this);
    }
    else
        pTarget->RemoveAurasByCasterSpell(linkedSpell, GetAffectiveCasterGuid());
}
