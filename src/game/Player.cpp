...
bool Player::CheckTransferPossibility(AreaTrigger const*& at)
{
    ...
    switch (GetAreaTriggerLockStatus(at, GetDifficulty(targetMapEntry->IsRaid())))
    {
        ...
        default:
            DEBUG_LOG("HandleAreaTriggerOpcode: unhandled LockAreaStatus %u, do nothing", uint8(GetAreaTriggerLockStatus(at, GetDifficulty(targetMapEntry->IsRaid()))));
            return false;
    }
